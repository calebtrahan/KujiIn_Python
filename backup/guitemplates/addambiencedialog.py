...
class Ui_addambienceDialog(object):
    def setupUi(self, addambienceDialog):
        ...
        addambienceDialog.resize(734, 478)
        self.audioFilesTable = QtGui.QTableWidget(addambienceDialog)
        self.audioFilesTable.setGeometry(QtCore.QRect(60, 70, 631, 291))
        ...
        self.previewSlider.setGeometry(QtCore.QRect(300, 410, 221, 20))
        ...
        self.pushButton.setGeometry(QtCore.QRect(150, 370, 101, 31))
        ...
        self.horizontalSlider.setGeometry(QtCore.QRect(600, 410, 81, 20))
